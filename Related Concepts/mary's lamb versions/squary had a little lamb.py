...
#-----------------------function(s)-----------------------
make_44k_array = lambda duration, frequency: [(-2*round((frequency*x)%1)+1) for x in duration*np.linspace(0, 1, int(duration*44000))]
m4a = make_44k_array
...
write('''mary's square.wav''', 44000, scaled)
